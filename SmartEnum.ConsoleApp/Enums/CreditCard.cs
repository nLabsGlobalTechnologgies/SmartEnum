...
{
    public static readonly CreditCard3 Standard = new("Cuma 1", nameof(Standard));
    public static readonly CreditCard3 Platinum = new("Cuma 2", nameof(Platinum));
    public static readonly CreditCard3 Premium = new("Cuma 3", nameof(Premium));
